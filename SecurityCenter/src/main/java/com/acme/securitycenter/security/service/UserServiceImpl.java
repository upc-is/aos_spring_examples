package com.acme.securitycenter.security.service;

import com.acme.securitycenter.security.domain.model.entity.Role;
import com.acme.securitycenter.security.domain.model.entity.User;
import com.acme.securitycenter.security.domain.model.enumeration.Roles;
import com.acme.securitycenter.security.domain.persistence.RoleRepository;
import com.acme.securitycenter.security.domain.persistence.UserRepository;
import com.acme.securitycenter.security.domain.service.UserService;
import com.acme.securitycenter.security.domain.service.communication.AuthenticateResponse;
import com.acme.securitycenter.security.domain.service.communication.RegisterRequest;
import com.acme.securitycenter.security.domain.service.communication.RegisterResponse;
import com.acme.securitycenter.security.middleware.JwtHandler;
import com.acme.securitycenter.security.middleware.UserDetailsImpl;
...
import com.acme.securitycenter.shared.mapping.EnhancedModelMapper;
        ...
        try {
            ...
            if (rolesStringSet == null) {
                ...
                rolesStringSet.forEach(roleString ->
                        roleRepository.findByName(roleString)
                                .map(roles::add)
                                .orElseThrow(() -> new RuntimeException("Role not found.")));
            }
